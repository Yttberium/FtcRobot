...
import org.firstinspires.ftc.teamcode.teamcode.Autonomous.roadrunner.messages.ThreeDeadWheelInputsMessage;

@Config
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 5307.682361574544; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -5383.041048961272; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2843.9236084590802; // x position of the perpendicular encoder (in tick units)
    }
